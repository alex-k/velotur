...
class Smarty extends Smarty_Internal_Data {
	...
	*/
    ...
    public $_validate_processed=0;
    public $_validate_error=0;
    public $_validate_error_fields='';
    ...
    {
        // display template
        $this->_display_called=TRUE;
        $this->fetch ($template, $cache_id, $compile_id, $parent, true);
        unset ($this->_display_called);
    }
    ...
    * clean up properties on cloned object
	...
	function include_plugin($type,$name) {
			foreach ($this->plugins_dir as $value) {
			    $filepath = $value ."/$type.$name.php";
