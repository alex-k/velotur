...
class HTML_QuickForm_Renderer_Default extends HTML_QuickForm_Renderer
{
    ...
    */
    var $_headerTemplate =  "";
//        "<tr class=ttitle><td><b>{header}</b></td></tr>";
    ...
    */
    var $_elementTemplate = 
        "<tr class=tbody><td class=tbody><!-- BEGIN required --><span >*</span><!-- END required -->{label}</td><td>{element}<!-- BEGIN error --><span>{error}</span><!-- END error --></td></tr>";
    ...
    */
    var $_formTemplate = 
        "<form{attributes} onSubmit='xajax_submitForm(xajax.getFormValues(\"signupForm\")); return false;'><div>{hidden}<table class=main>{content}</table></div></form>";
    ...
    */
    var $_requiredNoteTemplate = 
        "<tr><td></td><td>{requiredNote}</td></tr>";
    ...
    */
    function _prepareTemplate($name, $label, $required, $error)
    {
        ...
        if ($required) {
            ...
            $html = preg_replace("/([ \r]*)?<!-- BEGIN required -->.*<!-- END required -->([ \r]*)?/isU", '', $html);
        }
        if (isset($error)) {
            ...
            $html = preg_replace("/([ \r]*)?<!-- BEGIN error -->.*<!-- END error -->([ \r]*)?/isU", '', $html);
        }
        if (is_array($label)) {
    ...
    */
    ...
    function clearAllTemplates()
    {
        ...
        $this->setFormTemplate("<form{attributes}>{content}</form>");
