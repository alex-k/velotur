...
require_once($_CONF[root_dir].$_CONF[pear_dir].'PEAR.php');
require_once($_CONF[root_dir].$_CONF[pear_dir].'Config/Container.php');
...
class Config {
    ...
    */
	...
	global $_CONF;
        $file_exists = @include_once($_CONF[root_dir].$_CONF[pear_dir].$configInfo[0]);
        if ($file_exists) {
    ...
    */
	...
	global $_CONF;
        include_once($_CONF[root_dir].$_CONF[pear_dir].$includeFile);
