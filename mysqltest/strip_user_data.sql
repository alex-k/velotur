...
# update User set userEmail=concat(substr(md5(rand()),1,8),'@staging.velotur.ru') where userEmail>'';
...
#update User set userPassport=(FLOOR( 100000 + RAND( ) *100000 ) where userPassport>'';
update User set userPassportIssuedBy=substr(md5(rand()),1,10) where userPassportIssuedBy>'';
update User set userPassportIssuedDate=concat((FLOOR( 2010 + RAND( ) *20 )),'-01-20') where userPassportIssuedDate>'';
update User set userPassportValidThrow=concat((FLOOR( 2010 + RAND( ) *20 )),'-01-20') where userPassportValidThrow>'';
update User set userPhone=1234567 where userPhone>'';

#update Guide set guideEmail1=concat(substr(md5(rand()),1,10),'-guide@staging.velotur.ru') where guideEmail1>'';
#update Guide set guideEmail2=concat(substr(md5(rand()),1,10),'-guide@staging.velotur.ru') where guideEmail2>'';
...
update Guide set userPassportValidThrow=concat((FLOOR( 2010 + RAND( ) *20 )),'-01-20') where userPassportValidThrow>'';
